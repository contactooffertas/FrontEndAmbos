...
function HomePageBody() {
  ...
  const [searchRadiusInfo, setSearchRadiusInfo] = useState<SearchRadiusInfo | null>(null);
    ...
    if (searchParam) {
      ...
      fetch(`${API}/search?${params.toString()}`, { signal: controller.signal, cache: "no-store" })
        ...
        .then((data) => {
          ...
          setSearchRadiusInfo(data?.radius?.expanded ? data.radius as SearchRadiusInfo : null);
