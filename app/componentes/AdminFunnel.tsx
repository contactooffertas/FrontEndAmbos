...
import { BarChart3, Download, MousePointerClick, Smartphone, Users, UserRoundCheck, Globe2, RefreshCw } from "lucide-react";
    ...
    <div className="adm-card" style={{padding:"1rem 1.1rem",marginBottom:"1rem",background:"linear-gradient(135deg,#17243a,#0d1728)",border:"1px solid rgba(249,115,22,.2)"}}>
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:12,flexWrap:"wrap"}}>
        ...
        <div style={{display:"flex",gap:8,alignItems:"center"}}>
          ...
          <button onClick={load} aria-label="Actualizar embudo" style={{width:38,height:38,display:"grid",placeItems:"center",borderRadius:10,border:"1px solid rgba(249,115,22,.28)",background:"rgba(249,115,22,.08)",color:"#f97316",cursor:"pointer"}}><RefreshCw size={16}/></button>
        </div>
      </div>
    </div>
